...
const userAllergyIngreSchema = new mongoose.Schema({    
    ...
    ingredientID: {type: SchemaTypes.Long, min: 0, default: 0},
    createdDate: Date
}, { collection: 'UserAllergyIngredients' }, 
{ toJSON: { virtuals: true },
toObject: { virtuals: true }
});
